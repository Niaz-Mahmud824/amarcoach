    ...
    @if(isset($sliders))
        <div class="bg-blue-gray">
            <section class="container-fluid">
                <div id="home-background-slider" class="background-slider-block owl-carousel pt-3">
                                     ...
                                     <div class="image-overlay-slider">
                                         <div class="row no-gutters">
                                            <div class="col-lg-12 {{$slider['left'] == 1 ? 'col-md-offset-6 col-sm-offset-6 col-sm-6 col-md-6 text-right' : ''}}">
                                                <div class="home-dtl">
                                                    <h2 class="home-heading text-shadow ">{{ str_limit($slider['heading'], $limit = 20, $end = '...') }}</h2>
                                                    <p class="home-subheading text-shadow ">{{ str_limit($slider['sub_heading'], $limit = 60, $end = '...') }} </p>
                                                    <a href="{{ $slider['detail']}}" class="btn btn-xs btn-danger home-button"> Click Here To Watch</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<div class="bg-blue-gray">
    <!-- learning-work start -->
    @if(isset($facts))
    <section id="learning-work" class="learning-work-main-block bg-blue-gray mb-3">
        <div class="container">
            <div class="row">
    ...
    <br>
    <section id="student" class="student-main-block bg-blue-gray pt-3">
    <div class="container">
  ...
  @if(Auth::check())
    ...
    <section id="student" class="student-main-block bg-blue-gray">
        <div class="container">

            @if($total_count !== 0)
            <h4 class="student-heading text-white">{{ __('frontstaticword.RecentlyViewedCourses') }}</h4>
                    ...
                    <div class="item   student-view-block student-view-block-1">
                        <div class="genre-slide-image">
                            <div class="view-block">
                                ...
                                @endif
                                <div class="view-dtl">
                                    <div class="view-heading text-white btm-10"><a href="{{ route('user.course.show',['id' => $recent_course->id, 'slug' => $recent_course->slug ]) }}">{{ str_limit($recent_course->title, $limit = 30, $end = '...') }}</a></div>
                                    <div class="btm-10 details-text">{!! str_limit($recent_course->detail, $limit = 50, $end = '...') !!}</div>
                                    <p class="btm-10"><a herf="#"> {{ $recent_course->user['fname'] }} {{ $recent_course->user['lname'] }} <i class="fa fa-check icon-circle" aria-hidden="true"></i>
</a></p>
                                    ...
                                    <div class="row no-gutters">
                                        <div class="col-6">
                                             <p class="btm-10 date-box"><a herf="#"> {{ date('F j, Y', strtotime($recent_course['created_at'])) }}</a></p>
                                        </div>
                                        <div class="col-6">
                                            ...
                                            <div class="rate price-box">
                                                <ul>
                                                    ...
                                                    @if($recent_course->discount_price == !NULL)
                                                        ...
                                                        <li><a><span><i class="{{ $currency->icon }}"></i>{{ $recent_course->discount_price }}</span></a></li>&nbsp;
                                                        <li><a><span><strike><i class="{{ $currency->icon }}"></i>{{ $recent_course->price }}</strike></span></a></li>

                                                    @else
                                                        <li><a><span><i class="{{ $currency->icon }}"></i>{{ $recent_course->price }}</span></a></li>
                                                    @endif
                                                </ul>
                                            </div>
                                            @else
                                            <div class="rate price-box">
                                                <ul>
                                                    <li><a><span>{{ __('frontstaticword.Free') }}</span></a></li>
                                                </ul>
                                            </div>
                                            @endif
                                         </div>
    ...
    <section id="student" class="student-main-block bg-blue-gray">
        <div class="container">
            ...
            @if(count($enroll) > 0)
            <h4 class="student-heading text-white">{{ __('frontstaticword.MyPurchasedCourses') }}</h4>
                    ...
                    <div class="item   student-view-block student-view-block-1">
                        <div class="genre-slide-image">
                            <div class="view-block">
                                ...
                                <div class="view-dtl">
                                    <div class="view-heading text-white btm-10"><a href="{{ route('course.content',['id' => $enrol->courses->id, 'slug' => $enrol->courses->slug ]) }}">{{ str_limit($enrol->courses->title, $limit = 30, $end = '...') }}</a></div>
                                    <div class="btm-10 details-text">{!! str_limit($enrol->courses->detail, $limit = 50, $end = '...') !!}</div>
                                    <p class="btm-10"><a herf="#"> {{ $enrol->courses->user['fname'] }} {{ $enrol->courses->user['lname'] }} <i class="fa fa-check icon-circle" aria-hidden="true"></i></a></p>
                                    <div class="rating d-none">
                                        <ul>
                                            <li>
                                                <?php
                                ...
                                <div class="row no-gutters">
                                    <div class="col-6">
                                        <p class="btm-10 date-box"><a herf="#"> {{ date('F j, Y', strtotime($enrol->courses['created_at'])) }}</a></p>
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <div class="rate price-box">
                                            <ul>
                                                ...
                                                @if($enrol->courses->discount_price == !NULL)
                                                    ...
                                                    <li><a><span><i class="{{ $currency->icon }}"></i>{{ $enrol->courses->discount_price }}</span></a></li>&nbsp;
                                                    <li><a><span><strike><i class="{{ $currency->icon }}"></i>{{ $enrol->courses->price }}</strike></span></a></li>

                                                @else
                                                    <li><a><span><i class="{{ $currency->icon }}"></i>{{ $enrol->courses->price }}</span></a></li>
                                                @endif
                                            </ul>
                                        </div>
                                    @else
                                        <div class="rate price-box">
                                            <ul>
                                                <li class="price bg-pink"><a><span>{{ __('frontstaticword.Free') }}</span></a></li>
                                            </ul>
                                        </div>
                                    @endif
...
<section id="categories" class="bg-blue-gray categories-main-block">
    <div class="container">
        <h3 class="categories-heading btm-30 text-white">Browse Categories</h3>
        <!-- <h3 class="categories-heading btm-30"> Browse categories {{ __('frontstaticword.FeaturedCategories') }}</h3> -->
        <div id="browse-categories-slider" class="owl-carousel">

            @foreach($category as $t)
            @if($t->status == 1 && $t->featured == 1)

            <div class="item browse-cat-item">
                ...
                <div class="browse-cat-text bg-green yx-1 ">
                     <div class="row no-gutters text-white">
                        <div class="col-6">{{ str_limit($t['title'], $limit = 10, $end = '...') }} </div>
                        @php
                         $count_course=App\Course::where('category_id',$t->id)->get()->count()
                        @endphp
                        <div class="col-6 pull-right"><i class="fa fa-eye"></i> {{$count_course}} videos</div>
                    </div>
                </div>
...
<!-- categories end -->
    ...
    @if(isset($categories))
    <section id="learning-courses" class="learning-courses-main-block bg-blue-gray">
        <div class="container">
            <h4 class="student-heading text-white">{{ __('frontstaticword.RecentCourses') }}</h4>
            <div class="row">
    ...
    <br>
    <section id="student" class="student-main-block ptm-40 bg-blue-gray">
    <div class="container">
    <a href="{{ $adv->url1 }}" title="{{ __('Click to visit') }}">
    <img class="lazy img-fluid advertisement-img-one" data-src="{{ url('images/advertisement/'.$adv->image1) }}"
    alt="{{ $adv->image1 }}">
    ...
    <section id="student" class="student-main-block bg-blue-gray">
        <div class="container">
            <h4 class="student-heading text-white">{{ __('frontstaticword.FeaturedCourses') }}</h4>
                    ...
                    <div class="item   student-view-block student-view-block-1">
                        <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block{{$c->id}}">
                            <div class="view-block">
                                <div class="view-img">
                                    @if($c['preview_image'] !== NULL && $c['preview_image'] !== '')
                                        <a href="{{ route('user.course.show',['id' => $c->id, 'slug' => $c->slug ]) }}"><img data-src="{{ asset('images/course/'.$c['preview_image']) }}" alt="course" class="img-fluid owl-lazy">
                                            <div class="time-box" style="background-color:black !important; color:white; text-align: center; font-size:12px; margin-left: auto; position:absolute; bottom:5px; right:0px; padding-right: 5px; padding-left: 5px;">

                                                @php

                                                    $classtwo =  App\CourseClass::where('course_id', $c->id)->sum("duration");
                                                    $classesCount = count(App\CourseClass::where('course_id', $c->id)->get());


                                                @endphp

                                                <small style="color: white">{{ $classtwo . " min ".$classesCount . " lectures "  }}</small>
                            ...
                            @if($c['tags'] == !NULL)
                                ...
                                @endif
                                <div class="view-dtl">
                                    <div class="view-heading text-white btm-10"><a href="{{ route('user.course.show',['id' => $c->id, 'slug' => $c->slug ]) }}">{{ str_limit($c->title, $limit = 30, $end = '...') }}</a></div>
                                    <div class="btm-10 details-text">{!! str_limit($c->detail, $limit = 50, $end = '...') !!}</div>
                                    <p class="btm-10"><a herf="#"> {{ $c->user['fname'] }} {{ $c->user['lname'] }} <i class="fa fa-check icon-circle" aria-hidden="true"></i></a></p>
                                    <div class="rating d-none">
                                        <ul>
                                            <li>
                                                <?php
                                        ...
                                        <div class="rate price-box">
                                            <ul>
                                                ...
                                                @if($c->discount_price == !NULL)
                                                    ...
                                                    <li><a><span><i class="{{ $currency->icon }}"></i>{{ $c->discount_price }}</span></a></li>&nbsp;
                                                    <li><a><span><strike><i class="{{ $currency->icon }}"></i>{{ $c->price }}</strike></span></a></li>

                                                @else
                                                    <li><a><span><i class="{{ $currency->icon }}"></i>{{ $c->price }}</span></a></li>
                                                @endif
                                            </ul>
                                        </div>
                                    @else
    ...
    <section id="subscription" class="student-main-block bg-blue-gray">
        <div class="container">
            @if (isset($subscriptionBundles) && !$subscriptionBundles->isEmpty())
                <h4 class="student-heading text-white">{{ __('frontstaticword.SubscriptionBundles') }}</h4>
                            ...
                            <div class="item   student-view-block student-view-block-1">
                                <div class="genre-slide-image protip" data-pt-placement="outside"
                                    ...
                                    <div class="view-block">
                                        ...
                                        <div class="view-dtl">
                                            <div class="view-heading text-white btm-10"><a href="{{ route('bundle.detail', $bundle->id) }}">{{ str_limit($bundle->title, $limit = 30, $end = '...') }}</a>
                                            </div>
                                            <div class="btm-10 details-text">{!! str_limit($bundle->detail, $limit = 50, $end = '...') !!}</div>
                                            <p class="btm-10"><a herf="#">
                                                    {{ $bundle->user['fname'] }} {{ $bundle->user['lname'] }} <i class="fa fa-check icon-circle" aria-hidden="true"></i></a></p>



                                        <div class="row no-gutters">
                                            <div class="col-6">
                                                <p class="btm-10 date-box"><a herf="#"> {{ date('F j, Y', strtotime($bundle['created_at'])) }}</a></p>
                                            </div>
                                            <div class="col-6">
                                            @if ($bundle->type == 1)
                                                <div class="rate price-box">
                                                    <ul>
                                                        ...
                                                        @if ($bundle->discount_price == !null)
                                                            ...
                                                            <li><a><span><i class="{{ $currency->icon }}"></i>{{ $bundle->discount_price }}/{{ $bundle->billing_interval }}</span></a>
                                                            </li>&nbsp;
                                                            <li><a><span><strike><i class="{{ $currency->icon }}"></i>{{ $bundle->price }}/{{ $bundle->billing_interval }}</strike></span></a>
                                                            </li>

                                                        @else
                                                            <li><a><span><i class="{{ $currency->icon }}"></i>{{ $bundle->price }}/{{ $bundle->billing_interval }}</span></a>
                                                            </li>
                                                        @endif
                                                    </ul>
                                                </div>
    ...
    <!-- Bundle start -->
    @if(isset($bundles))
    <section id="bundle-block" class="student-main-block bg-blue-gray">
        <div class="container">
            @if(count($bundles) > 0)
            <h4 class="student-heading text-white">{{ __('frontstaticword.BundleCourses') }}</h4>
                    ...
                    <div class="item   student-view-block student-view-block-1">
                        <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-4{{$bundle->id}}">
                            <div class="view-block">
                                ...
                                <div class="view-dtl">
                                    <div class="view-heading text-white btm-10"><a href="{{ route('bundle.detail', $bundle->id) }}">{{ str_limit($bundle->title, $limit = 30, $end = '...') }}</a></div>

                                    <div class="btm-10 details-text">{!! str_limit($bundle->detail, $limit = 50, $end = '...') !!}</div>

                                    <p class="btm-10"><a herf="#"> {{ $bundle->user['fname'] }} {{ $bundle->user['lname'] }} <i class="fa fa-check icon-circle" aria-hidden="true"></i></a></p>
                                        ...
                                        <div class="rate price-box">
                                            <ul>
                                                ...
                                                @if($bundle->discount_price == !NULL)
                                                    ...
                                                    <li><a><span><i class="{{ $currency->icon }}"></i>{{ $bundle->discount_price }}</span></a></li>&nbsp;
                                                    <li><a><span><strike><i class="{{ $currency->icon }}"></i>{{ $bundle->price }}</strike></span></a></li>

                                                @else
                                                    <li><a><span><i class="{{ $currency->icon }}"></i>{{ $bundle->price }}</span></a></li>
                                                @endif
                                            </ul>
                                        </div>
                                    @else
    ...
    <br>
    <section id="student" class="student-main-block bg-blue-gray ptm-40">
    <div class="container">
    <a href="{{ $adv->url1 }}" title="{{ __('Click to visit') }}">
    <img class="lazy img-fluid advertisement-img-one" data-src="{{ url('images/advertisement/'.$adv->image1) }}"
    alt="{{ $adv->image1 }}">
    ...
    <section id="batch-block" class="student-main-block bg-blue-gray">
        <div class="container">
            @if(count($batches) > 0)
            <h4 class="student-heading text-white">{{ __('frontstaticword.Batches') }}</h4>
                    ...
                    <div class="item student-view-block student-view-block-1">
                        <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-5{{$batch->id}}">
                            <div class="view-block">
                                ...
                                <div class="view-dtl">
                                    <div class="view-heading text-white btm-10"><a href="{{ route('batch.detail', $batch->id) }}">{{ str_limit($batch->title, $limit = 30, $end = '...') }}</a></div>
                                    <p class="btm-10"><a herf="#"> {{ $batch->user['fname'] }} {{ $batch->user['lname'] }} <i class="fa fa-check icon-circle" aria-hidden="true"></i></a></p>

                                    <p class="btm-10"><a herf="#">{{ date('F j, Y',strtotime($batch['created_at'])) }}</a></p>
    ...
    <section id="student" class="student-main-block bg-blue-gray">
        <div class="container">
            ...
            @endphp
            @if( ! $meetings->isEmpty() )
            <h4 class="student-heading text-white">{{ __('frontstaticword.ZoomMeetings') }}</h4>
                    ...
                    <div class="item   student-view-block student-view-block-1">
                        <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-6{{$meeting->id}}">
                            <div class="view-block">
                                ...
                                <div class="view-dtl">
                                    <div class="view-heading text-white btm-10">{{ str_limit($meeting->meeting_title, $limit = 30, $end = '...') }}</div>
                                    <p class="btm-10"><a herf="#"> {{ $meeting->user['fname'] }} {{ $meeting->user['lname'] }} <i class="fa fa-check icon-circle" aria-hidden="true"></i></a></p>

                                    <p class="btm-10"><a herf="#"> {{ date('F j, Y | h:i:s A',strtotime($meeting['start_time'])) }}</a></p>
                                </div>
                            </div>
                        </div>
    ...
    <section id="student" class="student-main-block bg-blue-gray">
        <div class="container">
            ...
            @if( ! $bigblue->isEmpty() )
            <h4 class="student-heading text-white">{{ __('frontstaticword.BigBlueMeetings') }}</h4>
                    ...
                    <div class="item   student-view-block student-view-block-1">
                        <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-7{{$bbl->id}}">
                            <div class="view-block">
                                ...
                                <div class="view-dtl">
                                    <div class="view-heading text-white btm-10"><a href="{{ route('bbl.detail', $bbl->id) }}">{{ str_limit($bbl['meetingname'], $limit = 30, $end = '...') }}</a></div>
                                    <p class="btm-10"><a herf="#">{{ __('frontstaticword.by') }} {{ $bbl->user['fname'] }}</a></p>

                                    <p class="btm-10"><a herf="#"> {{ date('F j, Y | h:i:s A',strtotime($bbl['start_time'])) }}</a></p>
    ...
    <section id="student" class="student-main-block bg-blue-gray">
        <div class="container">
            ...
            <h4 class="student-heading text-white text-white">{{ __('frontstaticword.RecentBlogs') }}</h4>
                    ...
                    <div class="item   student-view-block student-view-block-1  ">
                        <div class="genre-slide-image @if($gsetting['course_hover'] == 1) protip @endif" data-pt-placement="outside" data-pt-interactive="false" data-pt-title="#prime-next-item-description-block-8{{$blog->id}}">
                            <div class="view-block">
                                ...
                                <div class="view-dtl">
                                    <div class="view-heading text-white btm-10"><a href="{{ route('blog.detail', $blog->id) }}">{{ str_limit($blog['heading'], $limit = 25, $end = '...') }}</a></div>
                                    <p class="btm-10"><a herf="#"> {{ $blog->user['fname'] }} {{ $blog->user['lname'] }} <i class="fa fa-check icon-circle" aria-hidden="true"></i></a></p>

                                    <p class="btm-10"><a herf="#"> {{ date('F j, Y | h:i:s A',strtotime($blog['created_at'])) }}</a></p>
    ...
    <section id="border-recommendation" class="border-recommendation bg-blue-gray">
        @php
    ...
    @endphp
    @if( ! $testi->isEmpty() )
    <section id="testimonial" class="testimonial-main-block bg-blue-gray">
        <div class="container">
    ...
    @if( !$trusted->isEmpty() )
    <section id="trusted" class="trusted-main-block bg-blue-gray">
        <div class="container">
            <div class="patners-block">

                <h6 class="patners-heading text-center text-white btm-40">{{ __('frontstaticword.Trusted') }}</h6>
    ...
    <section id="trusted" class="trusted-main-block bg-blue-gray">
        <!-- google adsense code -->
        <div class="container" id="adsense">
            @php
